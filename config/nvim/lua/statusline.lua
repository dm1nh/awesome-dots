...
function M.filename()
  local modified = vim.bo.modified and "●" or nil
  local readonly = (vim.bo.modifiable == false or vim.bo.readonly == true) and "󰭊" or nil

  return Utils.statusline.pretty_path() .. " " .. (modified or readonly or "")
end
...
M.ensure_content = vim.schedule_wrap(function()
  ...
  for _, win_id in ipairs(vim.api.nvim_list_wins()) do
    ...
    local is_disable = vim.tbl_contains(M.disabled_filetypes, vim.api.nvim_get_option_value("filetype", { buf = buf }))
